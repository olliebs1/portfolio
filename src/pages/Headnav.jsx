...
const Homepage = () => {
  ...
  return (
    ...
    <header>
      <div className="icons"> 
        <a href='https://www.linkedin.com/in/olivier-benson-smith/' target="_blank" rel="noopener noreferrer" ><SocialIcon network="linkedin" bgColor='#000000' style={{ height: 40, width: 40 }}/></a>
        <a href='https://github.com/olliebs1' target="_blank" rel="noopener noreferrer"><SocialIcon network="github" bgColor='#000000' style={{ height: 40, width: 40 }}/></a>
        <a href='/contact'><SocialIcon network="email" bgColor='#000000' style={{ height: 40, width: 40 }}/></a>
      </div>
